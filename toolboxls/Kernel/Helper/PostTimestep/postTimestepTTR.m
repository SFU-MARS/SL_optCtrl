...
%
% The final time to reach function will be stored in schemeData.ttr_backup
...
%
% Note that the minimum time reported by schemeData.ttr_backup will be the first
...
%
%   .ttr_backup           Time to reach function, in vector form.
