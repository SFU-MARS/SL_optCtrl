...
#/local-scratch/xlv/miniconda3/envs/py35_no_specific/bin/python $BASEDIR/train_ddpg.py --env_id=PlanarQuadEnv-v0 --reward_type=hand_craft --set_additional_goal=None