...
class env_quad_6d(object):
    ...
    def state_transition(self, s, a):
        ...
        state_ = np.array([s[0] + s[2] * self.delta,
                           ...
                           s[3] + self.delta * (
                                       -self.gravity + (-self.trans * s[3] + math.cos(s[4]) * action_sum) / self.mass),
                           s[4] + s[5] * self.delta,
    ...
    def value_iteration(self, mode="boltzmann"):
        iteration = 0
    ...
    def seek_neighbors_values(self, state, dim):
        ...
        return self.value[r[0][0]:r[0][1], r[1][0]:r[1][1], r[2][0]:r[2][1], r[3][0]:r[3][1], r[4][0]:r[4][1],
    ...
    def plot_2D_result(self, mode="max"):
        file = "../value_iteration_6d_xubo_version_1/value_matrix_quad_6D/transfered_value_matrix_7.npy"
    ...
    def test_interpolation(self):
        t = time.time()
        self.value = np.load("../value_iteration_6d_xubo_version_1/value_matrix_quad_6D/transfered_value_matrix_7.npy")
        interpolating_function = RegularGridInterpolator((self.state_grid[0],
                                                          self.state_grid[1],
                                                          self.state_grid[2],
                                                          self.state_grid[3],
    ...
    def generate_samples_interpolate(self, n):
        ...
        file_name = "../value_iteration_6d_xubo_version_1/value_matrix_quad_6D/transfered_value_matrix_7.npy"
...
env.value_iteration(mode = "default")
